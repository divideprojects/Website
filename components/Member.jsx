...
export default function Member(props) {
  return (
    <>
      <div className="max-w-xs mb-3 mt-4 ml-4 mr-4 max-h-max mx-auto overflow-hidden rounded-lg shadow-lg bg-gray-800">
        <div className="object-cover object-center w-full h-56 mb-10 rounded-t select-none">
          <Image src={props.img} alt="avatar" width={334} height={310} />
          {/* For Static Build */}
          {/* <img
            src={props.img}
            alt="avatar"
        ...
        <div className="flex items-center px-6 py-3 bg-gray-900 rounded-b-1"></div>

        <div className="px-6 py-4">
          <h1 className="text-xl font-semibold text-white">{props.name}</h1>

          <p className="py-2 text-gray-400">{props.skills}</p>
